  ...
  /*  public Monitor(){
    ...
    public void test() throws XmlRpcException{
    	 List<String> jammedRoads = new LinkedList<String>();
    	    ...
    	    Boolean res = (Boolean) client.execute("NavServer.setJamms",new Object[]{jammedRoads});
    		
    	    Object[] params = new Object[]{1};
    	    Object[] la = (Object[])client.execute("NavServer.getJammedRoads", params);
    }
    ...
    public void sendDataToNavService() throws XmlRpcException{
    	List<String> jammedRoads = new LinkedList<String>();
    	for(int i=0;i<roadNames.size();i++){
    		if(raodStates.get(i)){
