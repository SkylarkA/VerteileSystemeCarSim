...
public class CarSim {
    ...
    private void clalcPathOfCar(int index){
    	Car car = cars.get(index);   	
    
    	Vector<String> path = hn.dijkstra(car.location, car.dest);    
        ...
        car.sendOnJourney(car.dest, path);
    }
    
    public void initAsTestForNav(){
    	addCars(1,true);
    	cars.get(0).location ="Dortmund";
    	cars.get(0).dest = "Berlin";    
    	
    	clalcPathOfCar(0);
    	
    	addCars(1,true);
    	cars.get(1).location ="Bonn";
    	cars.get(1).dest = "Darmstadt"; 
    	cars.get(1).speed = 5;
